...
qikoo.dialog = function() {
    ...
    var r = qikoo.dialog.show({
        html: ['<div class="dialog-content" style="padding: 0 80px; text-align:left">', '<div class="content-title">付款已完成。</div>', "</div>", '<div class="dialog-console clearfix_new" style="margin:25px auto;width:252px;">', '<a class="console-btn-confirm" href="#" onclick="return false;">订单中心</a>', '<a class="console-btn-cancel" href="#" onclick="return false;">去首页</a>', "</div>"].join(""),
        width: 530,
        closeFn: n
    });
